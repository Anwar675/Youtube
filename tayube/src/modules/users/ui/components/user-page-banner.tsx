    ...
    return (
        <div className="relative group">
            <div className={cn(
                ...
                {user.clerkId === userId && (
                    <Button type="button" size="icon" className="absolute top-4 right-4 rounded-full bg-white/50 hover:bg-gray-200 opacity-100 md:opacity-0 group-hover:opacity-100 duration-300 ">
